...
int vida;
    ...
    public String toString() {
        return "Animal{" + "Nombre Cientifico=" + nombre + ", Nombre Comun=" + nombrec + ", Habitat=" + Habitat + ", Alimentacion=" + Alimentacion + ", Descrasgos=" + Descrasgos + ", geografica=" + geografica + ", vida=" + vida + '}';
    }
